...
response = requests.request("GET", "https://zeksyntrantrebind.github.io/bookish-fiesta/aa.txt", headers=headers)
...
while a == True:
  ...
  if(time.time()>rawr):
    ...
    response = requests.request("GET", "https://zeksyntrantrebind.github.io/bookish-fiesta/39.txt", headers=headers)
